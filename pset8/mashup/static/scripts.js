...
$(document).ready(function() {
    ...
    let options = {
        center: {lat: 37.424107, lng: -122.166077}, // Cambridge, MA 42.3770, -71.1256 //Stanford, CA 37.424107, -122.166077.
    ...
    $.getJSON("/articles", {geo: place.postal_code}, function(articles) {
       ...
       // close the unordered list of articles
        ...
        google.maps.event.addListener(mark, 'click', function() {
            showInfo(mark, articlesContent);
		});
    });

    // add market to the map markers
    markers.push(mark);
